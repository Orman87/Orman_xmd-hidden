...

{
  ...
  async ({ bot, m, reply, quoted, Access }) => {
    ...
    if (!quoted) {
      return reply('❌ Reply to a user message to get their profile picture.');
    }
    ...
    try {
      ...
      await bot.sendMessage(
        m.chat,
        {
          ...
          caption: '⚠️ User has no profile picture or privacy is enabled.'
        },
        { quoted: m }
      );
    }
